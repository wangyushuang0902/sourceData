...
def divideLevel(doublelineSource):
    ...
    unitLevel = 131072  #131072byte/s = 1Mbps
...
if __name__ == '__main__':
    #datap = '/home/wanwenkai/sourceData/TCP/original-doubleline/' 
    #first24hp = '/home/wanwenkai/sourceData/TCP/first24h-doubleline/'
    temp = '/home/wanwenkai/sourceData/TCP/first24h-30s-doubleline-nolevel/'
