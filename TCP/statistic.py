...
def main():
    path = '/home/wanwenkai/sourceData/TCP/first84h/30s/first84h-30s-80level-train'
    ...
    print 'train set avg bandwidth = %.2fbyte/s(%.2fMbps)' % (np.mean(bdL), np.mean(bdL)*8/1024/1024)
