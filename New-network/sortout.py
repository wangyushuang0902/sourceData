                    ...
                    for line in open(filespath):
                        ...
                        if tb[0] != '#':
                            ...
                            if time <= runtime*num:
                                ...
                                interpath = os.path.join(temp, transport+file_name)
                                with open(interpath, 'a') as inter:
...
def divideLevel(doublelineSource):
    ...
    divp = os.path.join(currentPath, '66h-30s-doubleline-'+str(levelnum)+'level')
...
if __name__ == '__main__':
    datap = '/home/wanwenkai/sourceData/New-network/original-doubleline/' 
    temp = '/home/wanwenkai/sourceData/New-network/66h-30s-doubleline-nolevel/'
